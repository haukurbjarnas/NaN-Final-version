...
# year1, month1, day1 = flight.departure_time.split()
# year2, month2, day2 = flight.arrival_time.split()
# time1 = datetime.date(year1, month1, day1)
# time2 = datetime.date(year2, month2, day2)
# if (start < time1) and (end > time1) and (start < time2) and (end > time2) == True:
# fitting_voyages.append(voyage)